...
Quy tắc này dựa trên phân tích dòng và không có thông tin kiểu, nên không thể phân biệt FK với trường thông thường — đó là lý do nó được đánh dấu `unsafe` và không có QuickFix. Nó cũng không theo dõi xem queryset đã có `select_related` đủ chưa; trình phân tích [`nplusone`](../../../rules/nplusone.md) của CLI có thể làm điều đó với thông tin schema. Sau khi đã sửa (hoặc với các trường scalar), hãy suppress finding.
